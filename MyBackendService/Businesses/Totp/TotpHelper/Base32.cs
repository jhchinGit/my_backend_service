...
namespace MyBackendService.Businesses.TotpHelper
{
    public static class Base32
    {
        private static string _allowedCharacters = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
        ...
        public static string Encode(string accountSecretKey)
        {
            ...
            for (var bitIndex = 0; bitIndex < data.Length * 8; bitIndex += 5)
            {
                ...
                output += _allowedCharacters[dualbyte];
            }
